  ...
  return (
    <section className="relative w-full min-h-[95vh] flex items-center overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-20 left-20 w-96 h-96 bg-accent/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
          ...
          <div
            ...
            <div className="space-y-6">
              ...
              <div className="inline-block px-6 py-3 bg-primary/20 backdrop-blur-sm rounded-full border border-primary/30">
                <span className="text-primary font-bold text-sm tracking-widest uppercase">Premium Collection 2026</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-gray-300 max-w-xl leading-relaxed">
                Discover <span className="font-bold text-primary">exclusive designs</span> that define your style. From bold graphics to artistic prints on premium quality tees.
              </p>
            </div>
          ...
          <div
            ...
            <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 bg-white px-8 py-4 rounded-2xl shadow-2xl border-4 border-primary/30 z-20">
              <div className="text-center">
                ...
                <div className="text-xs font-bold text-gray-900 uppercase tracking-wide">Limited Time</div>
              </div>
            </div>
          </div>
        </div>
