    ...
    <div className="border-t border-border pt-12 mb-16">
      ...
      <div className="prose max-w-none">
        {activeTab === 'description' && (
          <div className="space-y-4">
            <p className="text-foreground leading-relaxed">
              Experience ultimate comfort with our Classic Cotton T-Shirt. Made from 100% premium
              cotton, this t-shirt offers a soft, breathable feel perfect for everyday wear.
            </p>
            <h3 className="font-heading font-bold text-xl mt-6 mb-3">Features:</h3>
        ...
        {activeTab === 'size-guide' && (
          <div>
            <h3 className="font-heading font-bold text-xl mb-4">Size Chart (in inches)</h3>
        ...
        {activeTab === 'delivery' && (
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-foreground">
                  Delivered in 3-5 business days. Free delivery on orders above ₹999.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              <Icon name="BoltIcon" size={24} className="text-accent mt-1" />
              <div>
            ...
            <div className="flex items-start space-x-4">
              <Icon name="ArrowPathIcon" size={24} className="text-success mt-1" />
              <div>
